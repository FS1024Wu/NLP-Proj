...
object SparkPopularHashTags {
  ...
  def main() {
    val consumerKey="EmdTQYRZZWxMqbdzPbqjgpPXc"
	val consumerSecret="XKieJCPXHry72IW774JtYrsY4H6hqKjAy5lqDOvB51iBSm61at"
	val accessToken="1102064610872573952-38atplYCEWaIK6nifEBsZ7f8HJR1zF"	
	val accessTokenSecret="faxaCl71cmwSJpesHUfoeQrBxUnlsDRYSJqxTmJQGgMHU"
    sc.setLogLevel("WARN")
